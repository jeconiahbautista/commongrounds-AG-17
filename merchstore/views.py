...
class ProductDetailView(DetailView):
    ...
    def get(self, request, pk):
        ...
        is_owner = (
            request.user.is_authenticated and request.user.profile == product.owner
        )
        can_buy = request.user.is_authenticated and not is_owner and product.stock > 0
...
class ProductCreateView(RoleRequiredMixin, LoginRequiredMixin, CreateView):
    ...
    def form_valid(self, form):
        ...
        messages.success(self.request, form.instance.name, extra_tags="product_created")
...
class ProductUpdateView(RoleRequiredMixin, LoginRequiredMixin, UpdateView):
    ...
    def form_valid(self, form):
        ...
        messages.success(self.request, form.instance.name, extra_tags="product_updated")
...
class CartView(LoginRequiredMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        transactions = Transaction.objects.filter(buyer=user_profile).select_related(
